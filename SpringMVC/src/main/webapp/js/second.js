...
function init() {
    screenSet();
    $('.five').attr('valuenow','9487');
    $('.four').attr('valuenow','9453');
    $('.three').attr('valuenow','5566');
    $('.two').attr('valuenow','1357');
    $('.one').attr('valuenow','9996');
...
averageScore = (totalVotesInc / totalVotes).toFixed(1).toString();
rating.attr({
    'valuemax': totalVotes,
